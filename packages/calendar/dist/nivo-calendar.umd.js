(function (global, factory) {
    ...
    var commonEnhancers = [core.withTheme(), core.withDimensions(), _withPropsOnChange(['data', 'minValue', 'maxValue', 'colors'], function (_ref) {
      var data = _ref.data,
          minValue = _ref.minValue,
          maxValue = _ref.maxValue,
          colors = _ref.colors;
      var domain = computeDomain(data, minValue, maxValue);
      var colorScale = d3Scale.scaleQuantize().domain(domain).range(colors);
      return {
