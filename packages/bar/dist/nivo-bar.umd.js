(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-motion'), require('@nivo/core'), require('@nivo/axes'), require('prop-types'), require('lodash/isFunction'), require('lodash/isNumber'), require('lodash/isPlainObject'), require('lodash/min'), require('lodash/max'), require('lodash/range'), require('d3-scale'), require('lodash/flattenDepth'), require('d3-shape'), require('lodash/uniqBy'), require('recompose/setDisplayName'), require('recompose/compose'), require('recompose/defaultProps'), require('recompose/withPropsOnChange'), require('recompose/pure'), require('@nivo/colors'), require('@nivo/legends'), require('@nivo/tooltip'), require('@nivo/annotations')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-motion', '@nivo/core', '@nivo/axes', 'prop-types', 'lodash/isFunction', 'lodash/isNumber', 'lodash/isPlainObject', 'lodash/min', 'lodash/max', 'lodash/range', 'd3-scale', 'lodash/flattenDepth', 'd3-shape', 'lodash/uniqBy', 'recompose/setDisplayName', 'recompose/compose', 'recompose/defaultProps', 'recompose/withPropsOnChange', 'recompose/pure', '@nivo/colors', '@nivo/legends', '@nivo/tooltip', '@nivo/annotations'], factory) :
    (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.ReactMotion, global.nivo, global.nivo, global.PropTypes, global['lodash/isFunction'], global['lodash/isNumber'], global['lodash/isPlainObject'], global['lodash/min'], global['lodash/max'], global['lodash/range'], global.d3, global['lodash/flattenDepth'], global.d3, global['lodash/uniqBy'], global.RecomposeSetDisplayName, global.RecomposeCompose, global.RecomposeDefaultProps, global.RecomposeWithPropsOnChange, global.RecomposePure, global.nivo, global.nivo, global.nivo, global.nivo));
}(this, function (exports, React, reactMotion, core, axes, PropTypes, isFunction, isNumber, isPlainObject, min, max, range, d3Scale, flattenDepth, d3Shape, _uniqBy, setDisplayName, compose, defaultProps, withPropsOnChange, pure, colors, legends, tooltip, annotations) { 'use strict';
