(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('@nivo/colors'), require('@nivo/axes'), require('prop-types'), require('lodash/isFunction'), require('lodash/isNumber'), require('lodash/isPlainObject'), require('@nivo/tooltip'), require('d3-shape'), require('@nivo/scales'), require('@nivo/legends'), require('react-motion'), require('@nivo/voronoi')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', '@nivo/colors', '@nivo/axes', 'prop-types', 'lodash/isFunction', 'lodash/isNumber', 'lodash/isPlainObject', '@nivo/tooltip', 'd3-shape', '@nivo/scales', '@nivo/legends', 'react-motion', '@nivo/voronoi'], factory) :
    (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.nivo, global.nivo, global.PropTypes, global['lodash/isFunction'], global['lodash/isNumber'], global['lodash/isPlainObject'], global.nivo, global.d3, global.nivo, global.nivo, global.ReactMotion, global.nivo));
}(this, function (exports, React, core, colors, axes, PropTypes, isFunction, isNumber, isPlainObject, tooltip, d3Shape, scales, legends, reactMotion, voronoi) { 'use strict';
        ...
        layers.forEach(function (layer) {
          ...
          if (layer === 'legends') {
            ...
            legends$1.forEach(function (legend) {
              legends.renderLegendToCanvas(ctx, _objectSpread$c({}, legend, {
                data: legend.data || legendData,
                containerWidth: innerWidth,
                containerHeight: innerHeight,
                theme: theme
