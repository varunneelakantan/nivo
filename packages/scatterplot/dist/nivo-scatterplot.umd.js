(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('@nivo/axes'), require('@nivo/legends'), require('@nivo/colors'), require('@nivo/scales'), require('lodash/get'), require('lodash/isString'), require('lodash/isNumber'), require('lodash/isPlainObject'), require('d3-scale'), require('prop-types'), require('@nivo/tooltip'), require('react-motion'), require('@nivo/voronoi')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', '@nivo/axes', '@nivo/legends', '@nivo/colors', '@nivo/scales', 'lodash/get', 'lodash/isString', 'lodash/isNumber', 'lodash/isPlainObject', 'd3-scale', 'prop-types', '@nivo/tooltip', 'react-motion', '@nivo/voronoi'], factory) :
    (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.nivo, global.nivo, global.nivo, global.nivo, global['lodash/get'], global['lodash/isString'], global['lodash/isNumber'], global['lodash/isPlainObject'], global.d3, global.PropTypes, global.nivo, global.ReactMotion, global.nivo));
}(this, function (exports, React, core, axes, legends, colors, scales, get, isString, isNumber, isPlainObject, d3Scale, PropTypes, tooltip, reactMotion, voronoi) { 'use strict';
